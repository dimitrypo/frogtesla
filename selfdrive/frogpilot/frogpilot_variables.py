...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started):
    ...
    toggle.traffic_mode_follow = [(clip(params.get_float("TrafficFollow"), 0.5, 5) * 0.85) if traffic_profile and tuning_level >= level["TrafficFollow"] else (clip(default.get_float("TrafficFollow"), 0.5, 5) * 0.85), (clip(default.get_float("TrafficFollow"), 0.5, 5))]
    ...
    toggle.virtual_torque_blending = car_make == "tesla" and params.get_bool("VirtualTorqueBlending")
    toggle.hybrid_tacc = car_make == "tesla" and params.get_bool("HybridTACC")
