...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started):
    ...
    toggle.traffic_mode_follow = [(clip(params.get_float("TrafficFollow"), 0.5, 5) * 0.7) if traffic_profile and tuning_level >= level["TrafficFollow"] else (clip(default.get_float("TrafficFollow"), 0.5, 5) * 0.7), (clip(default.get_float("TrafficFollow"), 0.5, 5))]
